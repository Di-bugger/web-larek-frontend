...
- ```selectedItems: IProductItem``` - поле содержащиее выбранный товар.
...
- ```modal:open``` - для реагирования на открытие модального окна. БУдет использоваться для блокирования прокрутки страницы.
- ```modal:close``` - для реагирования на закрытие модального окна. БУдет использоваться для возобновления возмонжности прокрутки страницы.
...
- ```success:open``` - для открытия модального окна об успешном заказе .
